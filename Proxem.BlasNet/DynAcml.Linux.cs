...
{
    /// <summary>
    /// Wrapper for Amd's libacml.so
    /// </summary>
    public unsafe class DynAcmlLinux: IBlas
    {
        const string ACML_LINUX_DLL = "libacml.so";
        ...
        [DllImport(ACML_LINUX_DLL, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        {
            Blas.Provider = new DynAcmlLinux(-1);
