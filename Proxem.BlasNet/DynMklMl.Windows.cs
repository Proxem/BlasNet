...
{
    /// <summary>
    /// Wrapper for Intel's mklml.dll
    /// </summary>
    public unsafe class DynMklMlWindows: IBlas
    {
        const string MKLML_WINDOWS_DLL = "mklml.dll";
        ...
        /// </param>
        public DynMklMlWindows(int max = -1, string path = null)
        {
            if (path != null)
            {
        ...
        [DllImport(MKLML_WINDOWS_DLL, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        {
            Blas.Provider = new DynMklMlWindows(-1);
