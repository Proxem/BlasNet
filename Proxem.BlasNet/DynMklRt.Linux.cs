...
{
    /// <summary>
    /// Wrapper for Intel's libmkl_rt.so
    /// </summary>
    public unsafe class DynMklRtLinux: IBlas
    {
        const string MKLRT_LINUX_DLL = "libmkl_rt.so";
        ...
        public DynMklRtLinux(int max = -1)
        {
        ...
        [DllImport(MKLRT_LINUX_DLL, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        {
            Blas.Provider = new DynMklRtLinux(-1);
