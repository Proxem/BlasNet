...
{
    /// <summary>
    /// Wrapper for Amd's libacml_dll.dll
    /// </summary>
    public unsafe class DynAcmlWindows: IBlas
    {
        const string ACML_WINDOWS_DLL = "libacml_dll.dll";
        ...
        /// </param>
        public DynAcmlWindows(int max = -1, string path = null)
        {
            if (path != null)
            {
        ...
        [DllImport(ACML_WINDOWS_DLL, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        {
            Blas.Provider = new DynAcmlWindows(-1);
